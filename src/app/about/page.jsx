    ...
    <div className="flex flex-col gap-12">
      <div className="flex flex-col gap-12 mt-4 pt-6">
        ...
        <div className="flex-1">
          ...
          <p>
            Right now i am a gapyear student, but i still learning because for me lesson is priority and it is important, Right now i am learning about web developer, SNBT for 2025, self-improvement, these all i learn from youtube and some books. In the future time, maybe 1 months ago i will open colabolator for some projects, i wanna know and why if i work with a team.
            Thanks for reading
          </p>
        </div>
      </div>
